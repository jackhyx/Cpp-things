作者：ChocoWu
链接：https://www.nowcoder.com/discuss/1094052
来源：牛客网
...
6.http和https的区别？
7.分段和分页的区别？
8.rocketmq为什么不用zookeeper做注册中心？谈谈你的理解
9.谈谈netty对堆外内存的管理，如何回收堆外内存？
算法：
1.二叉树的最大宽度
2.和为k的子数组
第二天晚上收到电话告知通过
...
二面 60min
先聊项目，吧啦吧啦
1.mysql为什么用B+树做索引不用B树，为什么不用跳表做索引？
