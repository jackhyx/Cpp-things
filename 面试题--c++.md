...
链接：https://www.nowcoder.com/discuss/1072876
来源：牛客网
...
等一个offer的牛肉丸很有趣
编辑于 今天 20:20+ 关注
回忆版，发个面经求个好运气呜呜呜。被虐麻了


客户端一面  回忆版   1h


上来问了挺多react和css的东西，说好的一面不问项目的呢

1.react的特点以及数据流向，diff算法主要做了啥？
2.css如何让两个组件(view)并排并且显示最大显示，不用flex盒子怎么实现？（真不会）
3.redis哨兵   热key    （不会没看过...）
...
10.内存为什么要分段？分段就只是为了方便程序员吗？
11.java里继承会破坏封装性吗？（开放题）（我举了个String类）
12.https可以防止DNS劫持吗？（我答得不可以，但实际上理论上是可以的  哎）
